...
| `VITE_ZYFAI_API_KEY`            | Zyfai data API key                         |
...
This flow lets you verify the complete SDK lifecycle - Safe deployment, session key creation, fund management (deposit/withdraw), and data retrieval - for both existing users (with active positions) and brand-new wallets against the Zyfai backend.
